...
# Import training/validation spectra targets .xlsx
data_folder_train = "PATH_TO_FOLDER"
config_file_train = "TARGET_FILE.xlsx"
...
data_folder_spectra_train = "PATH_TO_FOLDER"
...
data_folder_test = "PATH_TO_FOLDER" 
config_file_test = "TARGET_FILE.xlsx"
...
data_folder_spectra_test = "PATH_TO_FOLDER"
...
# PCA
n_components = 8 # ~99% explained variance
...
for i in range(num_samples_test):
    ...
    if len(x) == len(y) == len(z):
        ...
        #plt.savefig(f"", bbox_inches='tight', dpi=400)
        plt.show()
